...
class Drive_Square:
    def __init__(self):
        ...
        #Initialize Pub/Subs
        self.pub = rospy.Publisher('/mybot002828js/car_cmd_switch_node/cmd', Twist2DStamped, queue_size=1)
        rospy.Subscriber('/mybot002828js/fsm_node/mode', FSMState, self.fsm_callback, queue_size=1)
    ...
    for i in range(4):
        ...
        rospy.sleep(2)   # adjust for ~1 meter
